...
export const COPY = {
  nb: {
    ...
    pointVoting: "Stem ved peking",
    manualVotingHint: "Stemming gjøres ved peking utenfor appen.",
    ...
    voteFor: "Stem på",
    manualVoteTitle: "Pek nå",
    manualVoteInstruction: "Pek på den du tror er spion, uten å bruke appen.",
  ...
  en: {
    ...
    pointVoting: "Vote by pointing",
    manualVotingHint: "Voting is done by pointing outside the app.",
    ...
    voteFor: "Vote for",
    manualVoteTitle: "Point now",
    manualVoteInstruction: "Point to who you think is the spy, without using the app.",
